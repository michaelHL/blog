...
alias poweroff='(shutdown -s -t 0 &); (net stop autossh_5677 &); (net stop autossh_5678 &);'
alias reboot='(shutdown -r -t 0 &); (net stop autossh_5677 &); (net stop autossh_5678 &);'
alias lcd='/d/UtilityPrograms/_exe/TurnOffLCD.exe'
alias wolfram='winpty /d/Mathematica/11.1/wolfram'
